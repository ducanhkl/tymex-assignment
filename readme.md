...
| **api-orders**  | GET    | `/order/:id/`                | Get specific order by ID (customer or admin)                   | -                                                                                                                                                           | ```json { "orderId": "98765", "customerId": "12345", "status": "pending", "items": [ { "itemId": "56789", "quantity": 2, "price": 29.99 } ] } ```     |
...
| **api-items**   | PUT    | `/item/hold/check-release`   | Check and release hold record if order is not placed           | ```json { "orderId": "98765", "expiryTime": "2024-10-07T13:05:00Z" } ```                                                                                    | ```json { "orderId": "98765", "status": "released", "updatedAt": "2024-10-07T14:10:00Z" } ```                                      |
